          ...
          <div className="col-lg-4 col-md-5 col-10 offset-1 offset-md-2">
            ...
            <form role="form" id="contact-form" method="post" action="https://formspree.io/mknqnbgb">
              ...
              <div className="submit text-center">
                <input type="submit" className="btn btn-process btn-raised" value="Contact Us" id="sbtns" />
              </div>
            </form>
          </div>
          <div className="col-md-6 offset-md-2">
            <h3 className="footer-title">DSC JIIT, powered by Google Developers</h3>
            <h4>Jaypee Institute Of Information Technology,<br />
              Noida, Uttar Pradesh, 201309<br />
              India</h4>
          </div>
          <div className="col-md-8 ml-auto mr-auto text-center">
            <h3 className="follow-title">Follow us on</h3><br />
            <div className="social-links list-unstyled">
              ...
              <a href="https://github.com/GDGJIITNOIDA">
                <img src="https://image.flaticon.com/icons/svg/25/25231.svg" width="35px" height="35px" />
              </a>
