                ...
                <div className="col-md-5 ml-auto mr-auto">
                  <div className="card card-profile card-plain">
                    <div className="card-header card-avatar">
                      <a href="#pablo">
                        <img className="img" src="/assets/img/coreteam/Members/dsc_lead.jpg" />
                      </a>
                    </div>
                    ...
                    <div className="card-footer justify-content-center">
                      <a href="" target="_blank"
                        className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
                      <a href="" target="_blank" target="_blank"
                        className="btn btn-just-icon btn-link btn-github"><i className="fa fa-github"></i></a>
                      <a href="" target="_blank"
                        className="btn btn-just-icon btn-link btn-twitter"><i className="fa fa-twitter"></i></a>
                      <a href="" target="_blank"
                        className="btn btn-just-icon btn-link btn-facebook"><i className="fa fa-facebook-square"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="container">
                ...
                <div className="col-md-4">
                    <div className="card card-profile card-plain">
                      <div className="card-header card-avatar">
                        <a href="#pablo">
                          <img className="img" src="/assets/img/coreteam/Members/dp.jpeg" />
                        </a>
                      </div>
                      <div className="card-body ">
                        <h4 className="card-title">Atishay</h4>
                      </div>
                      <div className="card-footer justify-content-center">
                        <a href="" target="_blank"
                          className="btn btn-just-icon btn-link btn-linkedin"><i className="fa fa-linkedin"></i></a>
